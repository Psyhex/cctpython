...
def find_maximum_distance(
    ...
    for i in range(1, len(cities_with_train_station)):
        max_distance = max(max_distance, (cities_with_train_station[i]-cities_with_train_station[i-1])//2)
    max_distance = max(max_distance, cities_with_train_station[0], number_of_cities-1 - cities_with_train_station[-1])
...
if __name__ == "__main__":
    ...
    assert find_maximum_distance(number_of_cities=10, cities_with_train_station=[0, 4]) == 5
